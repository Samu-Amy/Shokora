...
func (app *App) createProductHandler(w http.ResponseWriter, r *http.Request) {
	...
	// // Create product
	// if err := app.service.Product.Create(ctx, product); err != nil {
...
func (app *App) updateProductHandler(w http.ResponseWriter, r *http.Request) {
	...
	// // Update and return
	// if err := app.service.Product.Update(r.Context(), product); err != nil {
	// 	app.parseError(w, r, err)
	// 	return
	// }
...
func (app *App) deleteProductHandler(w http.ResponseWriter, r *http.Request) {
	...
	// if err := app.service.Product.Delete(ctx, productId); err != nil {
	// 	app.parseError(w, r, err)
	// 	return
	// }
...
// 	product, err := app.service.Product.GetById(ctx, productId)
// 	if err != nil {
// 		return nil, err
// 	}
